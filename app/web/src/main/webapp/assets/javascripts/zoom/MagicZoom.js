...
function MagicZoom_findZooms(container) {
	if(!container){
		return;
	}
    var loadingText = 'Loading Zoom';
    var loadingImg = '';
    var iels = document.querySelectorAll(container+" IMG");//window.document.getElementsByTagName("IMG");
    ...
    var aels = document.querySelectorAll(container+" A"); //window.document.getElementsByTagName("A");
    for (var i = 0; i < aels.length; i++) {
