...
(function (factory) {
    ...
    DEFAULT_PREVIEW = '<div class="file-preview-other">\n' +
        '   <span style="color:#fff!important;" class="{previewFileIconClass}">{previewFileIcon}</span>\n' +
        '</div>';
    defaultFileActionSettings = {
        removeIcon: '<i class="glyphicon glyphicon-trash text-danger"  style="color:#fff!important;"></i>',
        removeClass: 'btn btn-xs btn-default',
        removeTitle: 'Remove file',
        uploadIcon: '<i class="glyphicon glyphicon-upload text-info" style="color:#fff!important;"></i>',
        uploadClass: 'btn btn-xs btn-default',
        uploadTitle: 'Upload file',
        indicatorNew: '<i class="glyphicon glyphicon-hand-down text-warning" style="color:#fff!important;"></i>',
        indicatorSuccess: '<i class="glyphicon glyphicon-ok-sign text-success" style="color:#fff!important;"></i>',
        indicatorError: '<i class="glyphicon glyphicon-exclamation-sign text-danger" style="color:#fff!important;"></i>',
        indicatorLoading: '<i class="glyphicon glyphicon-hand-up text-muted" style="color:#fff!important;"></i>',
...
/*    tActions = ''*/
    ...
    FileInput.prototype = {
        ...
        setCaption: function (content, isError) {
            ...
            if (isError) {
                ...
                out = '<span style="color:#fff!important;" class="' + self.msgValidationErrorClass + '">' + self.msgValidationErrorIcon +
        ...
        renderButton: function (type) {
            ...
            if (!isEmpty(label)) {
                label = ' <span style="color:#fff!important;" class="' + self.buttonLabelClass + '">' + label + '</span>';
            }
    ...
    $.fn.fileinput.defaults = {
        ...
        browseIcon: '<i class="glyphicon glyphicon-folder-open" style="background:#01778c; color:#fff!important;"></i>',
        browseClass: 'btn btn-primary',
        removeIcon: '<i class="glyphicon glyphicon-trash" style="background:#01778c; color:#fff!important;"></i>',
        removeClass: 'btn btn-default',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle" style="background:#01778c; color:#fff!important;"></i>',
        cancelClass: 'btn btn-default',
        uploadIcon: '<i class="glyphicon glyphicon-upload" style="background:#01778c; color:#fff!important;"></i>',
        ...
        msgValidationErrorIcon: '<i class="glyphicon glyphicon-exclamation-sign" style="color:#fff;"></i> ',
        ...
        zoomIndicator: '<i class="glyphicon glyphicon-zoom-in" style="color:#fff!important;"></i>',
        ...
        errorCloseButton: '<span class="close kv-error-close" style="color:#fff!important;">&times;</span>',
        slugCallback: null,
